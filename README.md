...
For building machine learning model I used the data set from this link: https://www.kaggle.com/datasets/fedesoriano/heart-failure-prediction
...
Here is the jupyter notebook which i used to build this model: [[Model Building link](ML model/Project_Heart_Failure_Prediction.ipynb)](https://github.com/gurung-ajay/Heart-Failure-Prediction-App/blob/main/ML%20model/Project_Heart_Failure_Prediction.ipynb)
